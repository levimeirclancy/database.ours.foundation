...
echo "<header amp-fx='parallax' data-parallax-factor='1.2'><h1 property='name' amp-fx='parallax' data-parallax-factor='1.05'>" . implode("</span> • <span>", $entry_info['name']) . "</h1></header>";
