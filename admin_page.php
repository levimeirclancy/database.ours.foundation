...
echo "<amp-date-picker id='static-picker' type='single' mode='static' layout='fixed' height='600' width='360' format='YYYY-MM-DD' min='1000-00-00' date='".$entry_info['date_published']."' input-selector='#date_published'>";
