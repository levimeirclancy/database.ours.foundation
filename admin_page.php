...
foreach ($languages_array_temp as $language_temp):
	...
	$echo_temp .= "<div class='admin-page-input ".$hide_temp."' id='admin-page-title-".$language_temp."'>";
		...
		$echo_temp .= "<span role='button' tabindex='0' on='tap:name-".$language.".clear,admin-page-title-".$language.".hide,admin-page-title-".$language."-button.show'>Remove ".ucfirst($language_temp)."</span>";
		$echo_temp .= "</label>";
