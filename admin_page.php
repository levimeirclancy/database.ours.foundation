...
if (empty($entry_info['date_published'])): $entry_info['date_published'] = date("Y-m-d", time()); endif;
echo "<amp-date-picker id='static-picker' type='single' mode='static' layout='intrinsic' height='1' width='1' format='YYYY-MM-DD' min='1000-00-00' date='".$entry_info['date_published']."' input-selector='#date_published'>";
