...
function wrapper_buttons ($wrapper_temp, $descriptor_temp) {
	...
	echo "<span id='".$wrapper_temp."-hide' class='admin-page-table-hide-button' tabindex='0' role='button' on='tap:".$wrapper_temp.".hide,".$wrapper_temp."-show.show,".$wrapper_temp."-hide.hide' ".$hide_hidden_temp.">Hide ".$descriptor_temp."</span>";
	echo "<span id='".$wrapper_temp."-show' class='admin-page-table-show-button' tabindex='0' role='button' on='tap:".$wrapper_temp.".show,".$wrapper_temp."-show.hide,".$wrapper_temp."-hide.show' ".$show_hidden_temp.">Show ".$descriptor_temp."</span>";
