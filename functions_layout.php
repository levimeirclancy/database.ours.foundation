...
//	echo "<div role='button' tabindex='0' class='navigation-header-item' on='tap:logout.submit' submit-success>&#x2713; Logged out</div>";
	...
	echo "<amp-sidebar id='sidebar-search' layout='nodisplay' side='left' on='sidebarOpen:login-popover.close,settings-popover.close,new-popover.close'>";
		...
		echo "<div class='navigation-list'><div class='wrapper-list'>";
		echo "<amp-list id='sidebar-navigation-lightbox-search-list' credentials='include' layout='responsive' width='800' height='100' max-items='100' binding='refresh' reset-on-refresh='always' items='searchResults' [src]=\"'/api/search/?search=' + pageState.searchTerm\">";
