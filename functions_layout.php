...
//	echo "<base href='/' />";
	...
	$amp_state_temp = [];
	$amp_state_temp = [ "searchTerm" => "None", ]; // First we will set the search terms to blank
...
//	echo "<div role='button' tabindex='0' class='navigation-header-item' on='tap:logout.submit' submit-success>&#x2713; Logged out</div>";
	...
	echo "<amp-lightbox id='sidebar-navigation' layout='nodisplay' on='lightboxClose:navigation-header.show;lightboxOpen:navigation-header.hide' scrollable>";
		...
		echo "<div id='sidebar-navigation-search-button' role='button' tabindex='0' on='tap:AMP.setState({pageState: {SearchTerm: searchTemp}}),". implode(",", $tap_temp) .",sidebar-navigation-lightbox-search.open'>Search</div>";
