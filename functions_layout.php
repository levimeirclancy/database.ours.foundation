...
//	echo "<div role='button' tabindex='0' class='navigation-header-item' on='tap:logout.submit' submit-success>&#x2713; Logged out</div>";
	...
	echo "<amp-lightbox class='sidebar-navigation-lightbox' id='sidebar-navigation-lightbox-search' on='lightboxClose:sidebar-navigation-close.show;lightboxOpen:sidebar-navigation-close.hide,AMP.setState({pageState.searchTerm: pageState.searchTemp}),sidebar-navigation-lightbox-search-list.refresh' layout='nodisplay' scrollable>";
